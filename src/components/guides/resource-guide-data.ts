...
export const CLASSROOM_MANAGEMENT: GuideSection = {
  ...
  skills: [
    ...
    { name: 'Saphier: Attention Moves', what: 'Jon Saphier\'s "The Skillful Teacher" organizes attention moves on a continuum from Authority (desisting) to Attraction (winning). Teachers who can flexibly move across the continuum maintain engagement without escalation.', why: 'Most teachers default to desisting — the top of the continuum. Shifting even 20% of moves from desisting to enlisting or winning transforms a classroom. The continuum provides a concrete framework for expanding your repertoire.',
      howToTeach: [
        { step: 'Desisting Moves (High → Low Authority)', detail: 'Moves that stop unwanted behavior. Start at the bottom — proximity and a look solve 90% of problems. Escalate only as needed.\n\n• Proximity — Move near the off-task student without saying a word. Example: Walk toward Jiho while continuing your lesson.\n• Touch — A light hand on the desk or shoulder. Example: Tap Minseo\'s desk gently as you pass by.\n• Name Dropping — Weave the student\'s name into the lesson. Example: "If Yuna had 3 apples..."\n• Pause and Look — Stop talking and look at the student. Silence is powerful. Example: Mid-sentence, pause and make eye contact with the chatting pair.\n• Signals — Use a consistent non-verbal cue. Example: Hold up a "quiet" hand signal toward the noisy table.\n• Offer Help — "Do you need something?" Reframes misbehavior as a need. Example: "Seojun, do you need the directions again?"\n• Remind — Brief restatement of the expectation. Example: "Eyes on me, please."\n• Offer Choice — Give two acceptable options. Example: "You can work here quietly or move to the back table."\n• "I" Message — State how the behavior affects you. Example: "When I hear side conversations, I lose my train of thought."\n• Move Seat — Relocate the student. Example: "Hayoon, switch to this seat for now."\n• Private Desist — Quiet conversation away from the group. Example: Crouch next to the student and whisper.\n• Verbal Desist — Direct statement to stop. Example: "Please stop tapping your pencil."\n• Order — Firm directive. Example: "Sit down now."\n• Consequence — Apply a predetermined consequence. Example: "That\'s a yellow card — you\'ll miss 2 minutes of recess."' },
        { step: 'Alerting Moves (Proactive Engagement)', detail: 'Moves that maintain attention and prevent disengagement before it starts.\n\n• Circulation — Move around the room while teaching. Example: Walk between desks during independent work, glancing at each student\'s progress.\n• Eye Contact — Scan the room and lock eyes with different students. Example: Make deliberate eye contact with 4-5 students every 30 seconds.\n• Wait Time — Pause after a question to keep all students thinking. Example: "Think for 5 seconds... now raise your hand."\n• Random Order — Call on students unpredictably so everyone stays ready. Example: Draw popsicle sticks instead of taking volunteers.\n• Equal Opportunity — Ensure every student gets called on. Example: Track who you\'ve asked on a class list.\n• Unison Response — Have the whole class respond together. Example: "Everyone, what sound does \'sh\' make? Say it together."\n• Pre-alert — Warn students a question is coming. Example: "In 30 seconds I\'ll ask someone to summarize this paragraph."\n• Incomplete Sentences — Leave a blank for students to fill. Example: "The main character felt _____ because..."\n• Startle — Break a pattern with a sudden change. Example: Clap twice, whisper dramatically, or change your volume.\n• Use Student\'s Name in Example — Draws that student (and their friends) in. Example: "Imagine Sua opens a bakery and needs to calculate..."' },
        { step: 'Enlisting Moves (Intrinsic Motivation)', detail: 'Moves that make the content itself engaging — students pay attention because they want to.\n\n• Piquing Curiosity — Pose a mystery or puzzle. Example: "Something strange happens in the next paragraph. See if you can spot it."\n• Challenge — Set a bar that feels achievable but stretches them. Example: "I bet no one can find 3 adjectives in this sentence. Prove me wrong."\n• Suspense — Delay a reveal. Example: "I\'m going to show you a picture, but not yet... first, predict what it might be."\n• Making Student a Helper — Give a role. Example: "Jiho, you\'re my timer captain today. Tell us when 2 minutes are up."\n• Props — Use physical objects. Example: Bring a magnifying glass when teaching detective/inference skills.\n• Personification — Give objects or concepts a personality. Example: "This vowel is sneaky — it hides at the end of words and doesn\'t make a sound."\n• Voice Variety — Change pitch, speed, volume. Example: Whisper the important part of the lesson so students lean in.\n• Gesture — Use hands and body. Example: Act out the vocabulary word \'enormous\' by stretching your arms wide.\n• Connecting to Fantasies — Link content to students\' imaginations. Example: "If you were a character in this story, what would you do differently?"' },
        { step: 'Acknowledging', detail: 'Brief, non-verbal recognition that you see the student. Students who feel seen are less likely to seek attention through misbehavior.\n\n• A nod as a student settles into work. Example: Make eye contact with Hayoon and give a small nod as she opens her book.\n• A thumbs-up from across the room. Example: Catch Minseo on-task and flash a quick thumbs-up.\n• A brief "I see you." Example: Walking past Seojun: "I see you\'re already on number 4 — nice."\n• A smile when a student makes a good choice. Example: Sua helps a classmate without being asked; you catch her eye and smile.' },
        { step: 'Five Winning Moves (Attraction)', detail: 'The bottom of the continuum — the most powerful moves. Students are drawn to the lesson itself.\n\n• Encouragement — Voice quality that keeps students going. Example: "You\'re almost there, keep pushing — I can see you\'re thinking hard."\n• Enthusiasm — Genuine excitement. Example: "I LOVE this part of the story — wait until you see what happens next!"\n• Praise — Specific, naming the effort. Never just "good job." Example: "Jiho, you used three different transition words in that paragraph — that made your writing so much smoother."\n• Humor — Positive, mutual, never sarcasm. Example: Pretend to be confused by a silly answer: "Wait, cats can fly?! Did I miss something?" (class laughs together).\n• Dramatizing — Acting out content, stepping into character. Example: Read a character\'s dialogue in a dramatic voice, with gestures and facial expressions.' },
        { step: 'ESL Application', detail: 'Adapting the continuum for English language learners:\n\n• Use proximity and non-verbal desists before verbal ones — they work across language barriers.\n• Pair alerting moves with visual cues: hold up fingers for countdown, point to the board.\n• For enlisting, use props and dramatization heavily — physical and visual engagement transcends language.\n• Keep voice variety high — tone communicates meaning even when words are hard.\n• Never use sarcasm, which depends on language nuance students may miss.\n• Acknowledging moves are universal — a smile and a nod need no translation.' },
      ],
    },
  ],
  wida: [
