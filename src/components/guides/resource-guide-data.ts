...
export const PHONOLOGICAL_AWARENESS: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean has a highly regular sound-symbol system where each hangul block represents a predictable syllable. English phonological awareness is harder because the same letters can represent different sounds, and sounds can be spelled multiple ways.',
    'Several English phonemes do not exist in Korean: /f/, /v/, /z/, /θ/ (th as in think), /ð/ (th as in this). Students literally cannot hear these distinctions without explicit training. Minimal pair practice is essential.',
    'English vowel distinctions (bit/bet/bat/but/bot) are much finer than Korean vowel distinctions. Students may perceive multiple English vowels as the same sound.',
    'English permits complex consonant clusters (str-, -nds, -mpts) that are impossible in Korean phonology. Students may insert vowels between consonants: "strike" becomes "suh-tuh-rike."',
  ],
...
export const PHONICS: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean hangul maps symbols to sounds with near-perfect consistency. English spelling is opaque by comparison — one letter can represent many sounds. Students need explicit instruction in English spelling patterns far beyond what Korean literacy requires.',
    'Korean does not distinguish /l/ from /r/ — they are allophones. "Light/right," "lake/rake" confusions require sustained minimal pair practice.',
    'Final consonant clusters (jump, desk, strength) do not exist in Korean syllable structure. Students need specific attention to producing and hearing final clusters.',
    'Students may insert vowels between consonant clusters: "blue" → "buh-loo." Practice blending clusters without extra sounds using tactile cues (push sounds together physically).',
  ],
...
export const READING_FLUENCY: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean and English have very different prosody systems. Korean uses relatively level intonation with meaning conveyed through particles and endings. English uses dramatic pitch changes for emphasis, questions, and emotion. Model English prosody explicitly.',
    'Teach punctuation as "reading traffic signals": period = full stop and voice drops, comma = brief pause, question mark = voice rises, exclamation = strong feeling in voice. Korean students do not naturally make these voice changes.',
  ],
...
export const READING_SKILLS: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean reading instruction emphasizes recall and memorization over inference and analysis. Higher-order thinking skills need explicit, sustained instruction in the English program.',
    'Cultural background knowledge gaps affect comprehension significantly. Texts referencing American holidays, sports, geography, or pop culture require intentional pre-building of background knowledge.',
  ],
...
export const VOCABULARY: GuideSection = {
  ...
  koreanL1Considerations: [
    'Many academic English-Korean cognates exist through Sino-Korean roots (analyze = 분석, establish = 설립). Explicitly teaching these connections is a major accelerator for Korean ELLs.',
    'English idioms and figurative language do not transfer. "Break a leg," "piece of cake," "raining cats and dogs" are completely opaque. Teach as fixed expressions with visual support.',
  ],
...
export const GRAMMAR: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean SOV word order (I pizza eat) vs. English SVO (I eat pizza). Physical sentence-building with word cards helps rewire this pattern.',
    'Korean drops subjects when understood from context. Students write "Is happy" instead of "She is happy." Check every sentence for a subject.',
    'Korean particles (은/는, 을/를, 에) function differently from prepositions. Preposition errors are pervasive and long-lasting.',
    'Korean verbs never change form for subject, never split for questions, and always go at sentence end. Every aspect of English verb behavior must be explicitly taught.',
  ],
...
export const WRITING: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean essay structure builds to the main point at the end (기승전결). English states the thesis first. Explicitly teach English essay structure with graphic organizers.',
    'Korean spelling is regular; English is not. Allow invented spelling during drafting. Teach high-frequency words explicitly for editing.',
  ],
...
export const SPEAKING: GuideSection = {
  ...
  koreanL1Considerations: [
    'Korean classroom culture values listening over speaking and considers peer disagreement impolite. Build explicit norms: "Sharing ideas shows respect. Disagreeing with evidence shows strong thinking."',
    'Common pronunciation challenges for Korean speakers: /l/ vs. /r/, /f/ vs. /p/, /v/ vs. /b/, initial consonant clusters, English vowel distinctions. Focus on sounds that affect comprehensibility — not accent elimination.',
  ],
...
export const LISTENING: GuideSection = {
  ...
  koreanL1Considerations: [
    'English uses stress-timing (important words emphasized, function words reduced). Korean is syllable-timed (each syllable gets roughly equal time). Students may struggle to parse natural-speed English because unstressed words like "the," "a," "of" are nearly inaudible.',
    'Korean phonology does not distinguish certain English sounds (/l/ vs /r/, /f/ vs /p/, short vowel contrasts). These perception gaps affect listening comprehension at the word level — students may hear a different word than what was said.',
  ],
...
export const CLASSROOM_MANAGEMENT: GuideSection = {
  ...
  skills: [
    ...
    { name: 'ELL-Specific Management Strategies', what: 'Adaptations for managing a classroom where students have varying English proficiency levels.', why: 'Standard management advice assumes students understand the teacher. ELLs may not understand verbal directions, behavior expectations, or social norms. Adapt management to account for the language barrier.',
      howToTeach: [
        ...
        { step: 'Cultural behavior differences', detail: 'Korean students may avoid eye contact with teachers (sign of respect, not defiance). May not ask for help (cultural norm of not wanting to burden the teacher). May not volunteer answers (cultural value of humility). Teach that in this classroom, eye contact is friendly, asking for help is smart, and sharing ideas is expected.' },
      ],
    },
  ],
  wida: [
  ...
  koreanL1Considerations: [
    'Korean students may avoid eye contact with teachers as a sign of respect. Do not interpret this as defiance or disengagement. Teach explicitly: "In our classroom, looking at the teacher shows you are listening."',
    'Korean education culture emphasizes teacher authority and student compliance. Students may not question, disagree, or ask for clarification because it would seem disrespectful. Explicitly build a culture where questions are praised and disagreement is academic skill.',
  ],
