...
const F26_QUESTIONS: G2QuestionDef[] = [
  ...
  { qNum: 1, section: 'listening', sectionLabel: 'Listening: library', text: 'What is the story about?', choices: ['Kids can read books', 'Kids can do many fun things at a library', 'Kids like story time', 'Kids borrow new books'], correct: 'b', standard: 'RI.2.2', standardDesc: 'Identify the main purpose of a text', domain: 'Listening Comprehension', dok: 2, note: 'Main idea. a, c and d are each one activity the passage names; only b covers the whole list. A student summarising from the last thing they heard picks d.' },
  { qNum: 2, section: 'listening', sectionLabel: 'Listening: library', text: 'Where does the story happen?', choices: ['At school', 'At a park', 'In a library', 'At a bookstore'], correct: 'c', standard: 'SL.2.2', standardDesc: 'Recount key ideas from a text read aloud', domain: 'Listening Comprehension', dok: 1, note: 'Setting, stated outright. a and d are the other places books turn up, so they catch a student who held the word books more firmly than the word library.' },
  { qNum: 3, section: 'listening', sectionLabel: 'Listening: library', text: 'What can you NOT do at a library?', choices: ['Read', 'Listen to a story', 'Borrow a book', 'Play soccer'], correct: 'd', standard: 'RI.2.1', standardDesc: 'Ask and answer who, what, where, when, why and how questions', domain: 'Listening Comprehension', dok: 2, note: 'Negation. a, b and c are all in the passage, so a student who misses NOT picks whichever they remember most clearly rather than a random wrong answer.' },
  { qNum: 4, section: 'listening', sectionLabel: 'Listening: library', text: 'What can you find at the library?', choices: ['A swimming pool', 'A slide', 'Books about animals or space', 'A shopping cart'], correct: 'c', standard: 'SL.2.2', standardDesc: 'Recount key ideas from a text read aloud', domain: 'Listening Comprehension', dok: 1, note: 'Key detail. a and b are playground equipment and d belongs in a shop. All three test whether the answer came from the passage or from a general idea of places children go.' },
  { qNum: 5, section: 'listening', sectionLabel: 'Listening: library', text: 'What does "borrow" mean?', choices: ['Take something and return it later', 'Buy something', 'Give something away', 'Read very fast'], correct: 'a', standard: 'L.2.4a', standardDesc: 'Use sentence-level context as a clue to word meaning', domain: 'Vocabulary', dok: 2, note: 'Vocabulary in context. b is what you do at a bookstore and c is the opposite of borrowing. Those two are the standing confusions for this word.' },
  // Items 6-9 — Reading: sandwich procedure.
  { qNum: 6, section: 'reading_sandwich', sectionLabel: 'Reading: sandwich', text: 'What is this story about?', choices: ['Making a sandwich', 'The bread is soft', 'He puts the sandwich down', 'Eating a sandwich'], correct: 'a', standard: 'RI.2.2', standardDesc: 'Identify the main topic of a text', domain: 'Reading Comprehension', dok: 2, note: 'Main idea of a procedure. b and c are single steps lifted from the middle. d is the tempting one: eating is what happens last, so a student who summarises from the ending lands there.' },
  { qNum: 7, section: 'reading_sandwich', sectionLabel: 'Reading: sandwich', text: 'What happens last?', choices: ['Ben starts with bread.', 'Ben gets a plate.', 'He adds cheese and ham.', 'He eats the sandwich.'], correct: 'd', standard: 'RI.2.3', standardDesc: 'Describe the connection between steps in a procedure', domain: 'Reading Comprehension', dok: 2, note: 'Sequence. a is what happens first, so picking it means first and last were reversed rather than the order being lost entirely. b and c are middle steps.' },
  { qNum: 8, section: 'reading_sandwich', sectionLabel: 'Reading: sandwich', text: 'Which word rhymes with "plate"?', choices: ['cat', 'late', 'plant', 'down'], correct: 'b', standard: 'RF.2.3', standardDesc: 'Know and apply grade-level phonics and word analysis skills', domain: 'Phonics', dok: 1, note: 'Rhyme. c shares the opening blend pl-, which catches a student matching the start of the word instead of the end. a shares neither.' },
  { qNum: 9, section: 'reading_sandwich', sectionLabel: 'Reading: sandwich', text: 'How many toppings does Ben add to the sandwich?', choices: ['one', 'two', 'three', 'zero'], correct: 'b', standard: 'RI.2.1', standardDesc: 'Ask and answer questions about key details', domain: 'Reading Comprehension', dok: 1, note: 'Counting from the text. Cheese and ham make two. a comes from counting one, c from counting the bread as a topping.' },
  // Items 10-15 — Reading: "Leo's Snow Day".
  { qNum: 10, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'What is this story about?', choices: ['Leo likes cocoa', 'Leo has fun on a snowy day', 'Snow is cold', 'Coats keep you warm'], correct: 'b', standard: 'RL.2.2', standardDesc: 'Determine the central message of a story', domain: 'Reading Comprehension', dok: 2, note: 'Main idea. a and d are true details from the passage but not what it is about, which is the harder distinction; c is true of snow generally and never stated.' },
  { qNum: 11, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'What does Leo do first?', choices: ['He builds a snowman', 'He drinks hot cocoa', 'He wakes up and looks out the window', 'He puts on his coat'], correct: 'c', standard: 'RL.2.1', standardDesc: 'Ask and answer questions about key details', domain: 'Reading Comprehension', dok: 1, note: 'Sequence, signalled by First. a, b and d are the rest of the sequence in their right order, so the wrong answer names how far ahead the student jumped.' },
  { qNum: 12, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'What happens after Leo puts on his coat, hat, and mittens?', choices: ['He drinks cocoa right away', 'He looks out the window', 'He goes outside to build a snowman', 'He sees the snow'], correct: 'c', standard: 'RL.2.1', standardDesc: 'Ask and answer questions about key details', domain: 'Reading Comprehension', dok: 1, note: 'Sequence, signalled by Next and Last. b and d are earlier steps and a is the ending, so each wrong answer marks a different point in the order.' },
  { qNum: 13, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'Put these events in order: (1) Leo builds a snowman. (2) Leo puts on his coat. (3) Leo drinks hot cocoa.', choices: ['3, 2, 1', '2, 3, 1', '1, 2, 3', '2, 1, 3'], correct: 'd', standard: 'RL.2.5', standardDesc: 'Describe the overall structure of a story', domain: 'Reading Comprehension', dok: 2, note: 'Full sequence. c is the order the events are listed in the question rather than in the story, which is the commonest error here; a and b each reverse one pair.' },
  { qNum: 14, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'What is needed to build a snowman?', choices: ['Dark shade and rain', 'Cold weather and wind', 'Snow and cold weather', 'Hot rocks and soil'], correct: 'c', standard: 'RL.2.1', standardDesc: 'Ask and answer questions about key details', domain: 'Reading Comprehension', dok: 2, note: 'Inference. b is half right, since cold weather is needed but wind is never mentioned, so it catches a student who stops at the first plausible word.' },
  { qNum: 15, section: 'reading_leo', sectionLabel: 'Reading: Leo\'s Snow Day', text: 'Which word means the same as "perfect"? ("Now, Leo has had a perfect snow day!")', choices: ['terrible', 'boring', 'wonderful', 'weak'], correct: 'c', standard: 'L.2.5a', standardDesc: 'Word relationships and nuances in word meanings', domain: 'Vocabulary', dok: 1, note: 'Synonym in context. a, b and d are all negative, so the question is really testing whether the student registered that perfect is a positive word.' },
  // Items 16-31 — Language Standards. Read independently; read aloud only for
  // the whole class if a student cannot begin.
  { qNum: 16, section: 'language', sectionLabel: 'Language Standards', text: 'I brushed my _____ before bed.', choices: ['tooths', 'teeths', 'teeth', 'toothes'], correct: 'c', standard: 'L.2.1b', standardDesc: 'Form and use frequently occurring irregular plural nouns', domain: 'Language/Grammar', dok: 1, note: 'Irregular plural. a, b and d all apply a regular plural rule to an irregular word, and b applies it twice, to a form that is already plural.' },
  { qNum: 17, section: 'language', sectionLabel: 'Language Standards', text: 'I have two _____.', choices: ['dog', 'dogs', 'doges', 'dog\'s'], correct: 'b', standard: 'L.1.1c', standardDesc: 'Use singular and plural nouns with matching verbs', domain: 'Language/Grammar', dok: 1, note: 'Regular plural after a number. a leaves the noun singular; d is the possessive, which catches a student who has learned the apostrophe but not when it applies.' },
  { qNum: 18, section: 'language', sectionLabel: 'Language Standards', text: 'The cat _____ fast.', choices: ['run', 'running', 'runs', 'runned'], correct: 'c', standard: 'L.1.1c', standardDesc: 'Subject-verb agreement (singular)', domain: 'Language/Grammar', dok: 1, note: 'Subject-verb agreement, singular subject. a is the bare plural form, the default a student reaches for; d is a regularised past tense.' },
  { qNum: 19, section: 'language', sectionLabel: 'Language Standards', text: 'The rabbit hopped _____ across the yard.', choices: ['quick', 'quickly', 'quickest', 'quicker'], correct: 'b', standard: 'L.2.1e', standardDesc: 'Use adjectives and adverbs, choosing depending on what is modified', domain: 'Language/Grammar', dok: 1, note: 'Adverb. a is the adjective, far and away the commonest error. c and d are comparative and superlative, which catch a student matching word shape rather than reading the sentence.' },
  { qNum: 20, section: 'language', sectionLabel: 'Language Standards', text: 'I wanted to go outside, _____ it started to rain.', choices: ['so', 'but', 'or', 'and'], correct: 'b', standard: 'L.1.1g', standardDesc: 'Use frequently occurring conjunctions', domain: 'Language/Grammar', dok: 1, note: 'Conjunction showing contrast. a and d both join without contrast, so choosing one means only the first half of the sentence was read.' },
  { qNum: 21, section: 'language', sectionLabel: 'Language Standards', text: 'We celebrate _____ every January.', choices: ['new year\'s day', 'New Year\'s Day', 'new Year\'s day', 'New year\'s day'], correct: 'b', standard: 'L.2.2a', standardDesc: 'Capitalize holidays, product names and geographic names', domain: 'Language/Mechanics', dok: 1, note: 'Capitalising a holiday. Each wrong answer capitalises a different part of the name, so the choice shows which half of the rule is missing rather than only that it is.' },
  { qNum: 22, section: 'language', sectionLabel: 'Language Standards', text: 'That is _____ backpack by the door.', choices: ['my', 'mine', 'me', 'I'], correct: 'a', standard: 'L.1.1d', standardDesc: 'Use personal, possessive and indefinite pronouns', domain: 'Language/Grammar', dok: 1, note: 'Possessive determiner before a noun. b is the possessive pronoun, right only when no noun follows, and is the near miss worth watching for.' },
  { qNum: 23, section: 'language', sectionLabel: 'Language Standards', text: 'I want _____ apple.', choices: ['a', 'an', 'the', 'some'], correct: 'b', standard: 'L.1.1h', standardDesc: 'Use determiners (articles, demonstratives)', domain: 'Language/Grammar', dok: 1, note: 'Article before a vowel sound. a is what a student writes when they are not hearing the following word. c and d change the meaning rather than the grammar.' },
  { qNum: 24, section: 'language', sectionLabel: 'Language Standards', text: 'Do you like ice cream _____', choices: ['.', '!', '?', ','], correct: 'c', standard: 'L.1.2b', standardDesc: 'Use end punctuation for sentences', domain: 'Language/Mechanics', dok: 1, note: 'End punctuation matched to sentence type. a is the mark added without reading; b treats it as an exclamation, which catches anyone answering by feel rather than by the opening word Do.' },
  { qNum: 25, section: 'language', sectionLabel: 'Language Standards', text: 'Look at _____ birds in the tree!', choices: ['this', 'that', 'those', 'it'], correct: 'c', standard: 'L.1.1h', standardDesc: 'Use determiners (demonstratives, plural and distant)', domain: 'Language/Grammar', dok: 1, note: 'Demonstrative matched for number. a and b are singular, so they catch a student who did not carry the plural birds; d is not a demonstrative at all.' },
  { qNum: 26, section: 'language', sectionLabel: 'Language Standards', text: 'The dog was famished, so he ate his food quickly. What does "famished" mean?', choices: ['sleepy', 'very hungry', 'happy', 'sick'], correct: 'b', standard: 'L.2.4a', standardDesc: 'Use sentence-level context as a clue to word meaning', domain: 'Vocabulary', dok: 2, note: 'Vocabulary from context, where the clue is ate his food quickly. a and d would both explain NOT eating, so they catch a student guessing from the sound of the word rather than the sentence.' },
  { qNum: 27, section: 'language', sectionLabel: 'Language Standards', text: 'Which word is a compound word?', choices: ['happy', 'running', 'sunflower', 'tiny'], correct: 'c', standard: 'L.2.4d', standardDesc: 'Use knowledge of the meaning of individual words to predict compound words', domain: 'Vocabulary', dok: 1, note: 'Compound word. b carries a suffix and a is a single root. Both are simply longer words, which is what a student picks when looking for length rather than for two whole words joined.' },
  { qNum: 28, section: 'language', sectionLabel: 'Language Standards', text: 'Which word means "not happy"?', choices: ['happyful', 'happier', 'unhappy', 'happyless'], correct: 'c', standard: 'L.2.4b', standardDesc: 'Determine the meaning of a new word when a known prefix is added', domain: 'Vocabulary', dok: 1, note: 'Prefix for negation. a and d invent suffixes; b is a real word but comparative, so it catches a student who changed the word without checking the meaning that was asked for.' },
  { qNum: 29, section: 'language', sectionLabel: 'Language Standards', text: 'The dogs _____ fast.', choices: ['run', 'runs', 'running', 'to ran'], correct: 'a', standard: 'L.1.1c', standardDesc: 'Subject-verb agreement (plural)', domain: 'Language/Grammar', dok: 1, note: 'Subject-verb agreement, plural subject, and the mirror of question 18. b is the singular form. Comparing the two questions shows whether a student holds the rule or just prefers one ending.' },
  { qNum: 30, section: 'language', sectionLabel: 'Language Standards', text: 'Tomorrow, I _____ to the park.', choices: ['go', 'went', 'will go', 'going'], correct: 'c', standard: 'L.1.1e', standardDesc: 'Use verbs to convey a sense of past, present and future', domain: 'Language/Grammar', dok: 1, note: 'Future tense, signalled by Tomorrow. b is past and a is present, so either means the time word at the front of the sentence went unread.' },
  { qNum: 31, section: 'language', sectionLabel: 'Language Standards', text: 'Which sentence tells someone to do something?', choices: ['I like dogs.', 'Do you like dogs?', 'Close the door.', 'What a good dog!'], correct: 'c', standard: 'L.1.1j', standardDesc: 'Produce and expand declarative, interrogative, imperative and exclamatory sentences', domain: 'Language/Grammar', dok: 2, note: 'Sentence type. a is a statement, b a question and d an exclamation, so the four options are the four types and the wrong answer names which one was confused with a command.' },
]
 ...
 * a bare "RI.2.1" tells a teacher nothing about what was actually asked.
 */
export function g2StandardDescriptions(): Record<string, string> {
  const out: Record<string, string> = {}
  Object.values(G2_VERSIONS).forEach(c => {
