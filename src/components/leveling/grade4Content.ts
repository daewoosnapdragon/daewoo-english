...
const F26_QUESTIONS: G4QuestionDef[] = [
  ...
  { qNum: 21, section: 'verb_tense', sectionLabel: 'Language: verb tense and agreement', text: 'My friends _____ soccer after school.', choices: ['plays', 'played', 'playing', 'play'], correct: 'd', acceptable: ['b'], standard: 'L.4.1b', standardDesc: 'Form and use verb tenses', domain: 'Language/Grammar', dok: 1, note: 'Keyed to d -- agreement with a plural subject (my friends), which is what the item sets out to test. b is accepted too from August 2026: "My friends played soccer after school" is ordinary correct English, since nothing in the stem fixes the sentence in the present. a and c remain wrong -- the third person singular form does not agree with the plural subject, and the bare participle has no auxiliary.' },
...
const FALL_2026_CONTENT: G4Content = {
  ...
  documentNotes: [
    ...
    'Items 20 and 21 both accept a past-tense answer alongside the guide\'s key, because neither stem fixes its sentence in the present. Item 20 accepts b or c. c (walks) is the guide\'s key and the agreement the item is testing; b (walked) is accepted as well, because "The boy walked to school every day" is a habitual past and nothing in the stem rules it out. Read the item\'s analysis as a weaker signal on L.4.1b than it looks, and add a present-tense marker to the stem before the next sitting. Item 21 accepts b or d on the same grounds: d (play) is the guide\'s key and the agreement the item is testing; b (played) is accepted as well, because "My friends played soccer after school" is ordinary correct English.',
  ],
}
