...
export interface G1QuestionDef {
   ...
   * means -- is a lesson. Grade 1's choice sets are unusually deliberate about
   * this: the letter items put a target against its own mirror image, and the
   * sound items against the substitutions Korean makes for English phonemes it
   * does not have. Those are named here so the analysis can say which.
   */
  note?: string
}
...
const LEGACY_QUESTIONS: G1QuestionDef[] = [
  // Letter Names (Q1-5)
  { qNum: 1, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Circle the correct letter', choices: ['A', 'E', 'I', 'U'], correct: 'c', standard: 'RF.K.1d', standardDesc: 'Recognize upper/lowercase letters', domain: 'Letter Names', note: 'Letter name, vowels throughout, so the choice set isolates the name rather than the ability to spot a vowel.' },
  { qNum: 2, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Circle the correct letter', choices: ['B', 'd', 'b', 'P'], correct: 'b', standard: 'RF.K.1d', standardDesc: 'Recognize upper/lowercase letters', domain: 'Letter Names', note: 'Letter name against the reversal set. b is the mirror image of the target and should be the commonest wrong answer.' },
  { qNum: 3, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Circle the correct letter', choices: ['I', 'e', 'O', 'a'], correct: 'c', standard: 'RF.K.1d', standardDesc: 'Recognize upper/lowercase letters', domain: 'Letter Names', note: 'Letter name, two capitals against two lower case. Picking a lower-case form means case, not name, is the gap.' },
  { qNum: 4, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Circle the correct letter', choices: ['W', 's', 'X', 'V'], correct: 'a', standard: 'RF.K.1d', standardDesc: 'Recognize upper/lowercase letters', domain: 'Letter Names', note: 'Letter name. V is the target halved and X the other angular capital, so both catch shape matching rather than naming.' },
  { qNum: 5, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Circle the correct letter', choices: ['t', 'A', 'O', 'E'], correct: 'd', standard: 'RF.K.1d', standardDesc: 'Recognize upper/lowercase letters', domain: 'Letter Names', note: 'Letter name among three vowels and one lower-case consonant. Picking t means the student answered from shape.' },
  // Letter Sounds (Q6-10)
  { qNum: 6, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Circle the correct sound', choices: ['s', 'T', 'd', 'z'], correct: 'b', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences', domain: 'Letter Sounds', note: 'Letter sound. The set puts two sibilants against two stops, so the wrong answer shows whether the manner or the place of the sound was lost.' },
  { qNum: 7, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Circle the correct sound', choices: ['f', 'p', 'n', 'R'], correct: 'a', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences', domain: 'Letter Sounds', note: 'Letter sound. p is the standing substitution for /f/ in Korean and should dominate the wrong answers here.' },
  { qNum: 8, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Circle the correct sound', choices: ['D', 'B', 'c', 'S'], correct: 'b', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences', domain: 'Letter Sounds', note: 'Letter sound against the reversal set. D is the mirror image of the target, so a wrong answer here is often orientation rather than sound.' },
  { qNum: 9, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Circle the correct sound', choices: ['F', 'P', 'd', 'q'], correct: 'd', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences', domain: 'Letter Sounds', note: 'Letter sound. d and q are reversal partners and F and P the Korean substitution pair, so this one line tests two different confusions at once.' },
  { qNum: 10, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Circle the correct sound', choices: ['m', 'N', 'L', 'r'], correct: 'c', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences', domain: 'Letter Sounds', note: 'Letter sound. r is the classic /l/ confusion for Korean learners and is the informative wrong answer.' },
  // Word-Picture Match (Q11-20) — 3 choices each
  { qNum: 11, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['red', 'had', 'led'], correct: 'a', standard: 'RF.K.3c', standardDesc: 'Read common high-frequency words', domain: 'Word-Picture', note: 'Word-picture match. led is the /r/ and /l/ minimal pair, the standing Korean confusion; had differs in both onset and vowel, so picking it means the word was not decoded at all.' },
  { qNum: 12, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['ran', 'did', 'man'], correct: 'c', standard: 'RF.K.3c', standardDesc: 'Read common high-frequency words', domain: 'Word-Picture', note: 'Word-picture match. ran shares the rime -an and differs only in its onset, so the item isolates the initial consonant.' },
  { qNum: 13, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['see', 'tree', 'three'], correct: 'b', standard: 'RF.1.3g', standardDesc: 'Recognize common irregularly spelled words', domain: 'Word-Picture', note: 'Word-picture match. three differs from the target by one consonant inside the initial blend, which is exactly the contrast being tested.' },
  { qNum: 14, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['eat', 'lite', 'light'], correct: 'c', standard: 'RF.1.3g', standardDesc: 'Recognize common irregularly spelled words', domain: 'Word-Picture', note: 'Word-picture match on spelling rather than sound. lite is the phonetic spelling of the target, so picking it means the word was heard correctly and the spelling was not known.' },
  { qNum: 15, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['play', 'pay', 'day'], correct: 'a', standard: 'RF.K.3c', standardDesc: 'Read common high-frequency words', domain: 'Word-Picture', note: 'Word-picture match. pay is the target without its blend and day rhymes with it, so the two wrong answers separate a blend problem from a rhyme guess.' },
  { qNum: 16, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['hold', 'call', 'old'], correct: 'c', standard: 'RF.K.3c', standardDesc: 'Read common high-frequency words', domain: 'Word-Picture', note: 'Word-picture match. hold is the target with an onset added at the front, so picking it means an extra sound was heard there.' },
  { qNum: 17, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['draw', 'ring', 'drink'], correct: 'b', standard: 'RF.1.3g', standardDesc: 'Recognize common irregularly spelled words', domain: 'Word-Picture', note: 'Word-picture match. drink shares the -ink rime and draw shares the dr- blend, so each wrong answer catches attention paid to a different end of the word.' },
  { qNum: 18, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['first', 'grow', 'girl'], correct: 'c', standard: 'RF.1.3g', standardDesc: 'Recognize common irregularly spelled words', domain: 'Word-Picture', note: 'Word-picture match. first shares the -ir- vowel, which is the hard part of the target, so picking it means the vowel was right and the consonants were not.' },
  { qNum: 19, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['walk', 'work', 'warm'], correct: 'a', standard: 'RF.K.3c', standardDesc: 'Read common high-frequency words', domain: 'Word-Picture', note: 'Word-picture match on the r-coloured vowel. work and warm both carry the /r/ the target lacks, and that contrast is a standing difficulty for Korean learners.' },
  { qNum: 20, section: 'word_picture', sectionLabel: 'Word-Picture Match', text: 'Match the picture', choices: ['sleep', 'feet', 'five'], correct: 'b', standard: 'RF.1.3g', standardDesc: 'Recognize common irregularly spelled words', domain: 'Word-Picture', note: 'Word-picture match. sleep shares the long-e vowel and five shares the initial f, so the two wrong answers separate a vowel match from a consonant match.' },
  // Passage Comprehension "My Bag" (Q21-25)
  { qNum: 21, section: 'passage_comp', sectionLabel: 'Passage: "My Bag"', text: 'How many books are in the bag?', choices: ['1', '2', '3', '4'], correct: 'c', standard: 'RL.K.1', standardDesc: 'Key details in text', domain: 'Passage Comp', note: 'Counting from a passage, and the only item on the paper with four options rather than three, so a guess is worth less here than elsewhere.' },
  { qNum: 22, section: 'passage_comp', sectionLabel: 'Passage: "My Bag"', text: 'What color is the pencil case?', choices: ['blue', 'red', 'yellow'], correct: 'c', standard: 'RL.K.1', standardDesc: 'Key details in text', domain: 'Passage Comp', note: 'Key detail. The other two colours appear elsewhere in the passage, so this tests whether the attribute stayed attached to the right object.' },
  { qNum: 23, section: 'passage_comp', sectionLabel: 'Passage: "My Bag"', text: 'What shape is on the bag?', choices: ['square', 'circle', 'triangle'], correct: 'b', standard: 'SL.K.2', standardDesc: 'Key ideas from text read aloud', domain: 'Passage Comp', note: 'Key detail on shape vocabulary. These are the three basic shapes, so a wrong answer is a vocabulary gap rather than a listening one.' },
  { qNum: 24, section: 'passage_comp', sectionLabel: 'Passage: "My Bag"', text: 'Is there a red book?', choices: ['Yes, there is.', 'No, there isn\'t.'], correct: 'a', standard: 'RL.K.1', standardDesc: 'Key details in text', domain: 'Passage Comp', note: 'Yes/no on a detail. With two options a guess lands half the time, so read this item alongside 25 rather than on its own.' },
  { qNum: 25, section: 'passage_comp', sectionLabel: 'Passage: "My Bag"', text: 'Is the circle pink?', choices: ['Yes, it is.', 'No, it isn\'t.'], correct: 'a', standard: 'SL.K.2', standardDesc: 'Key ideas from text read aloud', domain: 'Passage Comp', note: 'Yes/no, and the pair to question 24. A student answering yes to both may be agreeing rather than listening, which the two items together reveal and neither shows alone.' },
]
...
const F26_QUESTIONS: G1QuestionDef[] = [
  ...
  { qNum: 1, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Teacher says: "E"', choices: ['A', 'E', 'I', 'U'], correct: 'b', standard: 'RF.K.1d', standardDesc: 'Recognize and name upper/lowercase letters', domain: 'Letter Names', note: 'Letter name, vowels throughout. Every choice is a vowel, so the item isolates knowing the name E rather than being able to spot a vowel.' },
  { qNum: 2, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Teacher says: "P"', choices: ['B', 'd', 'b', 'P'], correct: 'd', standard: 'RF.K.1d', standardDesc: 'Recognize and name upper/lowercase letters', domain: 'Letter Names', note: 'Letter name against the reversal set. b, d and P are all a circle and a stick; a student who has the name but not the orientation picks b or d, and which one they pick says which way they turn it.' },
  { qNum: 3, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Teacher says: "a"', choices: ['I', 'e', 'O', 'a'], correct: 'd', standard: 'RF.K.1d', standardDesc: 'Recognize and name upper/lowercase letters', domain: 'Letter Names', note: 'Letter name in lower case, mixed with two capitals. A student who knows only the capital forms picks I or O.' },
  { qNum: 4, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Teacher says: "V"', choices: ['W', 's', 'X', 'V'], correct: 'd', standard: 'RF.K.1d', standardDesc: 'Recognize and name upper/lowercase letters', domain: 'Letter Names', note: 'Letter name. W is the target doubled and X the other angular capital, so both catch a student matching shape rather than name.' },
  { qNum: 5, section: 'letter_names', sectionLabel: 'Letter Names', text: 'Teacher says: "t"', choices: ['t', 'A', 'O', 'E'], correct: 'a', standard: 'RF.K.1d', standardDesc: 'Recognize and name upper/lowercase letters', domain: 'Letter Names', note: 'Letter name, the only lower case among three capital vowels. Picking a vowel means the student went with the majority shape on the line rather than the letter they heard.' },
  // Items 6-10 — Listening: letter SOUNDS. Teacher says the sound, not the name.
  { qNum: 6, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Teacher says: /s/', choices: ['s', 'T', 'd', 'z'], correct: 'a', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences for consonants', domain: 'Letter Sounds', note: 'Letter sound. z is the voiced pair of the target and the distractor to watch: Korean has no /z/, so the two collapse for many learners and this is the item that shows it.' },
  { qNum: 7, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Teacher says: /r/', choices: ['f', 'p', 'n', 'R'], correct: 'd', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences for consonants', domain: 'Letter Sounds', note: 'Letter sound. f and p are the other standing confusion pair, so picking either means the sound was not held at all rather than swapped with its partner.' },
  { qNum: 8, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Teacher says: /b/', choices: ['D', 'B', 'c', 'S'], correct: 'b', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences for consonants', domain: 'Letter Sounds', note: 'Letter sound against the reversal set. D is the mirror image of B, which separates a sound the student does not know from a letter they cannot orient.' },
  { qNum: 9, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Teacher says: /f/', choices: ['F', 'P', 'd', 'q'], correct: 'a', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences for consonants', domain: 'Letter Sounds', note: 'Letter sound. P is the standing substitution for /f/, which Korean does not have, and should be the commonest wrong answer on this item.' },
  { qNum: 10, section: 'letter_sounds', sectionLabel: 'Letter Sounds', text: 'Teacher says: /l/', choices: ['m', 'N', 'L', 'r'], correct: 'c', standard: 'RF.K.3a', standardDesc: 'Letter-sound correspondences for consonants', domain: 'Letter Sounds', note: 'Letter sound. r is the classic /l/ confusion for Korean learners and is the informative wrong answer here; m and N mean the sound was not heard at all.' },
  ...
  { qNum: 11, section: 'picture_match', sectionLabel: 'Picture Match', text: '"He is reading a book."', choices: ['Man on bench (left)', 'Man reading under tree (middle)', 'Man drinking (right)'], correct: 'b', standard: 'SL.1.2', standardDesc: 'Answer questions about key details in a text read aloud', domain: 'Picture Match', choiceStyle: 'position', note: 'Picture match on the verb. The left picture has a man but no book and the right has a different action, so the wrong answer shows whether the student caught the person or the action.' },
  { qNum: 12, section: 'picture_match', sectionLabel: 'Picture Match', text: '"It is under the chair."', choices: ['Turtle under orange chair (left)', 'Turtle on table (middle)', 'Turtle in boat (right)'], correct: 'a', standard: 'SL.1.2', standardDesc: 'Answer questions about key details in a text read aloud', domain: 'Picture Match', choiceStyle: 'position', note: 'Picture match on the preposition. All three pictures show the same turtle, so only position differs and nothing but under is being tested.' },
  { qNum: 13, section: 'picture_match', sectionLabel: 'Picture Match', text: '"It\'s a square."', choices: ['Blue circle (left)', 'Green triangle (middle)', 'Orange square (right)'], correct: 'c', standard: 'L.K.5c', standardDesc: 'Real-life connections between words and their use', domain: 'Picture Match', choiceStyle: 'position', note: 'Picture match on shape vocabulary. Circle and triangle are the other two basic shapes, so this is a straight three-way knowledge check with nowhere to guess from context.' },
  { qNum: 14, section: 'picture_match', sectionLabel: 'Picture Match', text: '"Grandma is sleeping."', choices: ['Grandma in bed (left)', 'Grandma gardening (middle)', 'Grandma washing (right)'], correct: 'a', standard: 'SL.1.2', standardDesc: 'Answer questions about key details in a text read aloud', domain: 'Picture Match', choiceStyle: 'position', note: 'Picture match on the verb. All three show the same person, so the wrong answer names which activity was heard in place of sleeping.' },
  { qNum: 15, section: 'picture_match', sectionLabel: 'Picture Match', text: '"He is swimming."', choices: ['Boy swimming (left)', 'Boy building snowman (middle)', 'Boy reading (right)'], correct: 'a', standard: 'SL.1.2', standardDesc: 'Answer questions about key details in a text read aloud', domain: 'Picture Match', choiceStyle: 'position', note: 'Picture match on the verb. The middle picture is a winter activity and the right is indoors, so picking either means the verb was not held.' },
  // Items 16-19 — Listening: story "My Book", read twice. Choices printed a/b/c.
  { qNum: 16, section: 'story_comp', sectionLabel: 'Story: "My Book"', text: 'How many animals are in the book?', choices: ['2', '3', '4'], correct: 'c', standard: 'RL.K.1', standardDesc: 'Ask and answer questions about key details', domain: 'Story Comp', note: 'Counting from a story heard twice. The elephant, the bunny and two mice make four; picking 3 means the pair of mice was counted as one, which question 19 then tests directly.' },
  { qNum: 17, section: 'story_comp', sectionLabel: 'Story: "My Book"', text: 'What color is the bunny?', choices: ['It is white.', 'It is soft.', 'It is green.'], correct: 'a', standard: 'RL.K.1', standardDesc: 'Ask and answer questions about key details', domain: 'Story Comp', note: 'Key detail. b answers a different question about the same bunny, giving texture instead of colour, so it catches a student who heard the word bunny and stopped listening.' },
  { qNum: 18, section: 'story_comp', sectionLabel: 'Story: "My Book"', text: 'Which animal is gray?', choices: ['The elephant', 'The mice', 'The bunny'], correct: 'a', standard: 'SL.K.2', standardDesc: 'Confirm understanding of a text read aloud', domain: 'Story Comp', note: 'Key detail carried across the story. The other two animals are named with different colours, so this tests whether attributes stayed attached to the right animal.' },
  { qNum: 19, section: 'story_comp', sectionLabel: 'Story: "My Book"', text: 'Is there one mouse?', choices: ['Yes, there is one mouse.', 'No, there are two mouse.', 'No, there are two mice.'], correct: 'c', standard: 'SL.K.2', standardDesc: 'Confirm understanding of a text read aloud', domain: 'Story Comp', note: 'Number and irregular plural at once. b has the right number and the wrong plural, so it separates a student who did not hear the count from one who heard it but has not met mice.' },
]
