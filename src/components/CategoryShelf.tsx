...
export default function CategoryShelf({ counts, filters, setFilters, setActiveView }: CategoryShelfProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-cyber-bg page-enter">
      <div className="max-w-3xl mx-auto p-8">
        ...
        <p className="text-cyber-dim text-[12px] mb-8">Pull a spine to browse</p>
...
function Shelf({ items, colorOffset, pulledSpine, recentCat, subFolders, loadingFolders, getCount, onPull, onOpen, onOpenSubFolder, height }: ShelfProps) {
  return (
    <>
      <div style={{ display: 'flex', gap: 3, height, borderBottom: '2px solid #2a2a2a' }}>
        {items.map((item, i) => {
